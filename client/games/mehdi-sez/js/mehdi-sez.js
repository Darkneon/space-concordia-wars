(function() {
    ...
    window.M = function(options) {
        window.game = new Phaser.Game(800, 600, Phaser.CANVAS, 'theGame', { preload: preload, create: create, update: update, render: render });

        function preload() {

            game.load.spritesheet('item', options.path + '/assets/number-buttons.png', 160, 160);
        }
